...
var profiles = [
    Profile(name: "Eastern gray squirrel",
            picture: "eastern_gray_squirrel",
            food: "Foods tree bark, tree buds, flowers, berries, many types of seeds and acorns, walnuts, and other nuts, like hazelnuts and some types of fungi found in the forests, including fly agaric mushrooms.",
    ...
    Profile(name: "Deer Mouse",
            picture: "deer_mouse",
            food: "The main dietary items usually include seeds, fruits, arthropods, leaves, and fungi; fungi have the least amount of intake.",
